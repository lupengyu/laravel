...
<div class="login-box">
    <div class="box-con tran">
        <div class="login-con f-l">
            <form role="form" method="post" enctype="multipart/form-data" action="/adduser">
                ...
                <div class="form-group">
                    <input type="password" name="password" placeholder="密码" maxlength="18">
                    <span class="error-notic"></span>
                </div>
                <div class="form-group">
                    <input type="password" name="password2" placeholder="再次输入密码" maxlength="18">
                    <span class="error-notic">123</span>
                </div>
                ...
                <div class="form-group">
                    <input type="submit" id="login" class="button tran" value="注册" style="background: #03a9f4; color: white">
                </div>
            </form>
        </div>
    </div>
