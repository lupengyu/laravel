...
<div class="login-box">
    <div class="box-con tran">
        <div class="login-con f-l">
            <form role="form" method="post" enctype="multipart/form-data" action="/changepassword">
                <div style="margin-top: 10pt;margin-left: 80pt">
                </div>
                <h4>你的账号为{{$user->pstudentid}}</h4>
                <div class="form-group">
                    <input type="password" name="password1" placeholder="密码" maxlength="18">
